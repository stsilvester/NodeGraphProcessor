...
namespace GraphProcessor
{
    ...
    public class AddClassAttribute : Attribute
    {
        public string[] ClassList;

        public AddClassAttribute(params string[] className)
        {
            ClassList = className;
        }
    }
    ...
    [AttributeUsage(AttributeTargets.Field)]
    public class HideLabelAttribute : AddClassAttribute
    {
        public HideLabelAttribute() : base("hide-label")
        {
        }
    }
    ...
    {
        public string PortStyle;

        public PortStyleAttribute(string styleSheetPath)
        {
            PortStyle = styleSheetPath;
        }
    }
}